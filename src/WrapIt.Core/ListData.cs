...
namespace WrapIt
{
    internal class ListData : InterfaceData
    {
        ...
        public override string GetCodeToConvertToActualType(string parameterName) => ClassName != InterfaceName ? $"{parameterName}?.ToList()" : base.GetCodeToConvertToActualType(parameterName);
