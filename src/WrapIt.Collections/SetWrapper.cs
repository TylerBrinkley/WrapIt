...
namespace WrapIt.Collections
{
        ...
        where TWrapped : TInterface
    {
        ...
        public static implicit operator HashSet<T>(SetWrapper<T, TWrapped, TInterface> setWrapper) => setWrapper?.ToSet();
        ...
        public static SetWrapper<T, TWrapped, TInterface> Create(ISet<TInterface> list) => list != null ? new SetWrapper<T, TWrapped, TInterface>(list) : null;
        ...
        public HashSet<T> ToSet() => InternalWrapper.ToSet();
        ...
        private sealed class StandardSetWrapperInternal : StandardCollectionWrapperInternal<ISet<T>>, ISetWrapperInternal
        {
            ...
            public void ExceptWith(EnumerableWrapper<T, TWrapped, TInterface> other) => Collection.ExceptWith(other.ToEnumerable());

            public void IntersectWith(EnumerableWrapper<T, TWrapped, TInterface> other) => Collection.IntersectWith(other.ToEnumerable());

            public bool IsProperSubsetOf(EnumerableWrapper<T, TWrapped, TInterface> other) => Collection.IsProperSubsetOf(other.ToEnumerable());

            public bool IsProperSupersetOf(EnumerableWrapper<T, TWrapped, TInterface> other) => Collection.IsProperSupersetOf(other.ToEnumerable());

            public bool IsSubsetOf(EnumerableWrapper<T, TWrapped, TInterface> other) => Collection.IsSubsetOf(other.ToEnumerable());

            public bool IsSupersetOf(EnumerableWrapper<T, TWrapped, TInterface> other) => Collection.IsSupersetOf(other.ToEnumerable());

            public bool Overlaps(EnumerableWrapper<T, TWrapped, TInterface> other) => Collection.Overlaps(other.ToEnumerable());

            public bool SetEquals(EnumerableWrapper<T, TWrapped, TInterface> other) => Collection.SetEquals(other.ToEnumerable());

            public void SymmetricExceptWith(EnumerableWrapper<T, TWrapped, TInterface> other) => Collection.SymmetricExceptWith(other.ToEnumerable());

            public HashSet<T> ToSet() => Collection as HashSet<T> ?? new HashSet<T>(Collection);

            public void UnionWith(EnumerableWrapper<T, TWrapped, TInterface> other) => Collection.UnionWith(other.ToEnumerable());
        }
